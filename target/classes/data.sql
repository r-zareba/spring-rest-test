...
insert into task values (3, sysdate(), 'Run calculations', 2);
insert into task values (4, sysdate(), 'Validate model', 3);
insert into task values (5, sysdate(), 'Refactor code', 5);
insert into task values (6, sysdate(), 'Something to do', 5);
insert into task values (7, sysdate(), 'Update the confluence page', 5);